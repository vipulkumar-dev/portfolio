...
export default function TestimonialCard({
  ...
  return (
    <article className="swiper-slide mask   rounded-3xl  bg-colorSecondaryLight  px-16  py-[1.5em] opacity-80 max-md:px-5 md:min-w-[950px] md:rounded-[3rem] md:py-[1.1em] ">
