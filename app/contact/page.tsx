...
export default function ProfileForm() {
  const [status, setStatus] = useState<"filling" | "Loading" | "Success">(
    "filling",
  );
  ...
  return (
    <>
      ...
      <main className="darkGradient relative flex  w-full flex-col items-center justify-center px-paddingX py-paddingY text-[clamp(20px,_1.3vw_+_8px,_120px)] text-colorLight">
        <h1 className="mb-[1.5em] mt-[0.5em] text-[12.2vw] leading-[0.9] tracking-tight md:text-[clamp(16px,_6.3vw_+_8px,_120px)]">
